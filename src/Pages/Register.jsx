            ...
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto">
                ...
                <form onSubmit={handleFormSubmit} action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <input type="email" name="email" id="email" placeholder="email" className="w-full px-4 py-3 rounded-md dark:bg-gray-900 dark:text-gray-100 border" required />
                    </div>
                    <div className="space-y-1 text-sm">
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-400">Already have an account?
                    <Link rel="noopener noreferrer" to="/login" className="underline dark:text-indigo-300">Log in</Link>
                </p>
            </div>
        </div>
    );
