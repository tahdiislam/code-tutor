...
const Course = ({course}) => {
    ...
    return (
        <div>
            <Link rel="noopener noreferrer" to="/" className="my-4 block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900 hover:shadow-sm hover:shadow-gray-400">
